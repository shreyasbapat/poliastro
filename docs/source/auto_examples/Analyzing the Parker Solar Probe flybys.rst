.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_Analyzing the Parker Solar Probe flybys.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_Analyzing the Parker Solar Probe flybys.py:
...
:raw-math: `$$ T = 2 \pi \sqrt{\frac{a^3}{\mu}} \Rightarrow a = \sqrt[3]{\frac{\mu T^2}{4 \pi^2}}$$`
...
:raw-math: `$$ \varepsilon = -\frac{\mu}{r} + \frac{v^2}{2} = -\frac{\mu}{2a} \Rightarrow v = +\sqrt{\frac{2\mu}{r} - \frac{\mu}{a}}$$`
...
.. _sphx_glr_download_auto_examples_Analyzing the Parker Solar Probe flybys.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: Analyzing the Parker Solar Probe flybys.py <Analyzing the Parker Solar Probe flybys.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: Analyzing the Parker Solar Probe flybys.ipynb <Analyzing the Parker Solar Probe flybys.ipynb>`
